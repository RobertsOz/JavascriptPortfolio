...
class TexturePage
{
    ...
    DrawSprite(name, pos)
    {
        this.DrawSpriteInfo(BomberManInst.texturePage.metadata.lookup[name], pos);
    }
    ...
    {
        GAZCanvas.Sprite(BomberManInst.texturePage.image, new Rect(pos.x, pos.y, uvRect.w, uvRect.h), uvRect);
    }
}